...
w , h = screen.get_size()
bg = pygame.transform.scale(get_image("jpg/base_micky.jpg"), (w,h))
...
while not done :
    ...
    blitRotate(screen , get_image("jpg/second.png") , pos ,angle_sec )
    blitRotate(screen , get_image("jpg/minute.png"), pos , angle_min)
